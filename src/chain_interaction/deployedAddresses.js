...
export const ACTIVE_CHAIN_RPC = "https://polygon-mumbai-bor.publicnode.com";
export const activeChainId = 80001;
export const addressesOnActiveNetwork = contractAddreses?.find(item => item.network === activeChainId);
